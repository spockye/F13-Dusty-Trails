...
/obj/item/clothing/accessory/padding
	...
	icon_state = "padding"
	armor = list("melee" = 5, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = -20, "acid" = 45)
...
/obj/item/clothing/accessory/kevlar
	...
	icon_state = "padding"
	armor = list("melee" = 0, "bullet" = 5, "laser" = 0, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 25)
...
/obj/item/clothing/accessory/plastics
	...
	icon_state = "plastics"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 5, "energy" = 10, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = -40)
	flags_inv = HIDEACCESSORY
